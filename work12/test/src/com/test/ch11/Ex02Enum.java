...
public class Ex02Enum {
	...
	public static void main(String[] args) {
		...
		System.out.println("- ststic final int 사용 -");
		
		System.out.println("월급날의 요일을 숫자로 입력해주세요 (일: 1~ 토:7):");
		int payDay1 = s.nextInt();
		System.out.println("보너스 받는 달을 숫자로 입력해주세요: ");
		int bonusMonth1 = s.nextInt();
		
		if (payDay1 > bonusMonth1)
			System.out.println("날과 월은 비교할 수 없으므로 잘못된 코드입니다.");
		...
		*/
		...
		System.out.println("\n메소드 사용");
		System.out.println(bonusMonth2.plus(3).getOrdinal() + "월");
		...
		*/
		...
		case SUN:
			...
			break;
		case MON:
			System.out.println("월요일은 오후 3시에 입금죕니다.");
			break;
		default:
			System.out.println("오루 1시에 입금됩니다.");
			break;
		}
	}
