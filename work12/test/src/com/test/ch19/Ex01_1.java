...
public class Ex01_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		//BiPredicate는 인자로 전달된 두 개의 값에 대해 true 또는 false 값을 반환
		...
		System.out.println();
		//BinaryOperator는 동일한 타입의 인자를 두 개 받아 동일한 타입의 결과값을 반환
		...
		System.out.println();
		//IntFunction은 인자로 전달된 정수값을 입력으로 받아 다른 타입의 결과값을 반환
