	...
	public static void main(String[] args) {
		...
		try (
				DataOutputStream out = new DataOutputStream(new BufferedOutputStream(
						new FileOutputStream("src/com/test/ch21/out3-dataoutputstream.txt")));
			) {
	        ...
	        try (
	            DataInputStream in = new DataInputStream(new BufferedInputStream(
	            		new FileInputStream("src/com/test/ch21/out3-dataoutputstream.txt")));
	        ) {
	        ...
	        try (
	        	ObjectOutputStream out = new ObjectOutputStream(new BufferedOutputStream(
						new FileOutputStream("src/com/test/ch21/out3-objectoutputstream.txt")));
	        ) {
	        ...
	        try (
	        	ObjectInputStream in = new ObjectInputStream(new BufferedInputStream(
						new FileInputStream("src/com/test/ch21/out3-objectoutputstream.txt")));
	        ) {
